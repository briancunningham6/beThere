...
http.createServer(app).listen(config.MessageServerPort);
console.log('Express app started on port %j', config.MessageServerPort )
                    ...
                    if(eventInstancesList[i].status != 'Ready'){
                        ...
                        Event.findOne({'_id':eventInstancesList[i].event})
                            .exec(function(err,event){
                                ...
                                //TODO: fix the hours array values in the database
                                //console.log(event);
                                ...
                                deliveryTime = consts.getEveningTimeFromIndex(event.time);
                                deliveryHour = deliveryTime.substring(0, deliveryTime.lastIndexOf(':'));
                                if(deliveryHour > currentHour){
                                    return 'Not yet but in a few hours'
                                }
